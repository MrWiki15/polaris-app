...
import { formatCurrency, getInventoryValue, getLowStockProducts } from '@/lib/storage';
...
export const Inventario: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      key: 'cost',
      header: 'Costo',
      render: (product: Product) => formatCurrency(product.cost, settings.currencySymbol),
    ...
    },
    {
      ...
      header: 'Margen',
      render: (product: Product) => {
        const margin = ((product.price - product.cost) / product.cost * 100).toFixed(0);
        return (
          <span className={cn(
            'text-sm font-medium',
